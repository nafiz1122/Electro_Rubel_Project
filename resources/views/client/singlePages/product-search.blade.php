				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
                            ...
                            <div class="product-preview">
								<img src="/public/Upload/Product_images/Product_Sub_Images/{{ $img->sub_image }}" alt="">
							</div>
                            @endforeach
					...
					<div class="col-md-5">
						<div class="product-details">
							...
							<ul class="product-links">
								<li>Share:</li>
								<li><a href="https://www.facebook.com/winner.tech.bd"><i class="fa fa-facebook"></i></a></li>
